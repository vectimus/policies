...
- vectimus-supchain-009: Block pip install of praisonai or praisonaiagents pinned with == to any explicit version — covers sandbox escape CVE-2026-39888 (CVSS 9.9), YAML RCE CVE-2026-39890 (CVSS 9.8), and template injection CVE-2026-39891 (CVSS 8.8); all patched in praisonaiagents >= 1.5.115 / praisonai >= 4.5.115 (VTMS-2026-0041)
